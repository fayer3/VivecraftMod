...
layout(binding = 0) uniform sampler2D firstPersonColor;

layout(binding = 1) uniform sampler2D thirdPersonColor;
layout(binding = 2) uniform sampler2D thirdPersonDepth;

layout(binding = 0) uniform UBO {
    vec3 hmdViewPosition;
    vec3 hmdPlaneNormal;
