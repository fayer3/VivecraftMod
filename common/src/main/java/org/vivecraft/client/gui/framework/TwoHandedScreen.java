...
public abstract class TwoHandedScreen extends Screen {
    ...
    public boolean processCursor(Vector3f Pos_room, Matrix4f Rotation_room, boolean mainCursor) {
        Vector2f tex = GuiHandler.getTexCoordsForCursor(Pos_room, Rotation_room, GuiHandler.guiScale, this.dh.vrPlayer.vrdata_room_pre.getController(mainCursor ? 1 : 0));
