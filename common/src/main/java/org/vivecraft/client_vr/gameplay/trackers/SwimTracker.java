...
public class SwimTracker extends Tracker {
    ...
    private static final float riseSpeed = 0.005F;
    private static final float swimSpeed = 1.3F;
    ...
    public void doProcess(LocalPlayer player) {
        ...
        if (distDelta > 0.0D) {
            Vector3f velocity = moveDir.mul((float) distDelta * swimSpeed * dirFactor).mul(0.15F);
