...
public class IrisChunkProgramOverridesMixinSodium_0_6 implements ClassDependentMixin {

    @Unique
    private static final String vivecraft$dependentClass = "net.caffeinemc.mods.sodium.client.render.chunk.vertex.format.ChunkVertexType";
